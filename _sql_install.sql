...
('#modul_idname#', 0, 2, 4, 'thumbnail_type','Thumbnails','<a href=\"javascript:modulpopup(''01gallery'',''recreate_thumbnails'','''','''','''',510,450);\">Thumbnails neu generieren</a>','Dynamische Gr&ouml;&szlig;e (Seitenverh&auml;ltnis beibehalten)|Feste Gr&ouml;&szlig;e (Bilder werden zugeschnitten)','dyn|fix','','fix','fix','0','0'),
('#modul_idname#', 0, 2, 5, 'thumbwidth', 'Max. Kantenl&auml;nge f&uuml;r dynam. Thumbnails', 'Maximale Kantenl&auml;nge in Pixeln (ohne Einheit) angeben.', 'text', '5', 'Pixel', '120', '120', 0, 0),
('#modul_idname#', 0, 2, 6, 'fix_tb_size','Feste Thumbnail-Gr&ouml;&szlig;e','Breite und H&ouml;he in Pixeln ohne Einheit angeben.','text','10','Pixel (Breite x H&ouml;he)','x','100x75',0,0),
...
('#modul_idname#', 0, 1, 0, 'gals_listtype', 'Bilderalben ausgeben...','','Klassische Darstellung (Albentitel + Beschreibung)|Kompakte Darstellung (nur Ausgabe des Titels)','1|2','','1','2',0,0),
...
CREATE TABLE IF NOT EXISTS `01modulprefix_galerien` (
  ...
  `galeriename` varchar(255) NOT NULL,
  `beschreibung` text,
  `galpic` int(10) DEFAULT NULL,
  `anzahl_pics` int(5) NOT NULL,
  `uid` int(10) NOT NULL,
